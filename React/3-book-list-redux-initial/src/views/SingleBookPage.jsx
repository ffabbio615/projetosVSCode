...
function SingleBookPage() {
  ...
  function handleEraseBook(id){
    if(confirm('Are you sure you want to erase this book and all notes that are associated with it?')){
    ...
    <>
      <div className="container">
        ...
        {book ?
          ...
          <div>
            <p>Book not found. Click on the button above to go back to the list of books.</p>
          </div>
      }
</div>
    </>
